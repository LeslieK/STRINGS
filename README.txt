...
implementation of a Suffix Array from an input string (aka 'the text')
...
Some Client scripts:
LRS_script.py:
1 arg: filename: parses filename, reads in text, then finds longest repeated string (lrs)
...
- the twitter ids of people you follow and
- words/phrases that you track
This script demos KNUTH-MORRIS-PRATT matching algorithm in a streaming feed

To run: update the script with your creds, enter your own pattern to search, and run the script!
